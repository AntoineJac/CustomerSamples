        ...
        var
            ...
            createAds = function(dfpOptions, $adCollection) {
                ...
                $adCollection.each(function() {
                    ...
                    var $adUnit = $(this);
                    if ($adUnit.hasClass('display-block')){return};
                    count++;

                    // adUnit name
                    var adUnitName = getName($adUnit, dfpOptions);

                    var prebidDataParams = $adUnit.data('prebid');
                    if (prebidDataParams){
                    var jsonPrebid = JSON.stringify(eval("(" + prebidDataParams + ")"));
                    var prebidData = jQuery.parseJSON(jsonPrebid)
                    };
                    ...
                    var dimensionsMapped = ["300,250", "728,90","970,250","970,90","300,600","120,600","160,600"];

                    function isInArray(value, array) {
                        return array.indexOf(value) > -1;
                    }

                    function isDimensionPrebid() {
                        for (var k = 0; k < dimensions.length; ++k) {
                            if (isInArray(dimensions[k].toString(), dimensionsMapped)) return true;
                        };
                    };
                    ...
                    pbjs.que.push(function() {
                        ...
                        if (($adUnit.data('outofpage')) || (!isDimensionPrebid())) {
                            return;
                            //nothing
                        } else {
                        for (var j = 0; j < prebidData.length; ++j) {
                            bidDetails = {
                                                bidder: prebidData[j].bidder,
                                                params: prebidData[j].params
                                            };
                             adUnitsBids.push(bidDetails);
                              }
                            nextAdunitId = {
                                            code: adUnitID,
                                            sizes: dimensions,
                            ...
                            adUnits.push(nextAdunitId);                                                                
                        }
                    });

                    googletag.cmd.push(function() {

                        var $adUnitData = $adUnit.data(storeAs);
                     ...
                     pbjs.que.push(function() {
                        ...
                        },
                        {
                          ...
                          "increment" : 33.5
                            ...
                            bidCpmAdjustment : function(bidCpm, bid){
                            var currencyRate = 67;
                            return bidCpm * currencyRate * 0.92 ; 
                                     }}
                                };
                        ...
                        window.googletag.cmd.push(function() {
                            ...
                            $adCollection.each(function() { 
                                 ...
                                 if (dfpOptions.refreshExisting && $adUnitData && $adUnit.hasClass('display-block')) {
                                  ...
                                  adToDisplay.push($adUnit.data(storeAs));
                                 } 
                            });
                            window.googletag.pubads().refresh(adToDisplay);
...
//var kpageurl = window.location.href;
//if ((kpageurl.toLowerCase() == 'https://khabar.ndtv.com') || (kpageurl.toLowerCase() == 'https://khabar.ndtv.com/')) {
//    window.location = "https://khabar.ndtv.com/?breakconn=chakdefatte";
//}
