<script runat="server" language="JavaScript">
  ...
  var objDELength = objDE.length;
  
  var name = decodeURI(Request.GetQueryStringParameter('productName'));
  var img = decodeURI(Request.GetQueryStringParameter('productImg'));
  var id = objDELength+1;
