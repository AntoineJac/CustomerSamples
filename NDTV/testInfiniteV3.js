        ...
        var
            ...
            createAds = function(dfpOptions, $adCollection) {
                ...
                $adCollection.each(function() {
                    ...
                    var dimensionsMapped = ["300,250", "728,90","970x250","300x600"];

                    function isInArray(value, array) {
                        return array.indexOf(value) > -1;
                    }

                    function isDimensionFastlane() {
                    ...
                    rubicontag.cmd.push(function() {
                        ...
                        if (($adUnit.data('outofpage')) || (!isDimensionFastlane())) {
                            return;
                            //nothing
                        } else {
                            // googleAdUnit = window.googletag.defineSlot('/' + dfpID + '/' + adUnitName, dimensions, adUnitID).addService(window.googletag.pubads());
                            slot[nextSlotId] = rubicontag.defineSlot('/' + dfpID + '/' + adUnitName, dimensions, adUnitID);
                        ...
                        rubicontag.run(function() {
                            ...
                            gptran = true;
                            setTimeout(gptrun,1500);
                        }, {
                            slots: [slot[nextSlotId]]
                        });
                        // run rubicontag
                    });
                    //End of the Rubicon Code
                    //
