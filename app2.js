    ...
    return {
        ...
        execute: function() {
            AdManager = (function (_super) {
                ...
                AdManager.prototype.createSingleAd = function (targetSelector, cssClass, sizes, sizesMobile, prebid) {
                    var _this = this;
                    this.bootstrap();
                    var position = 1;
                    var prebid = prebid || 1;
                       ...
                       if (dfpAds.prebid !== 1) { 
                            ...
                            window.pbjs.que.push(function () {                     
                                    window.pbjs.rp.requestBids({
                                        callback: _this.loadATFAds2,
                                        gptSlotObjects: [dfpAds.slot],
                                        data: {
                            ...
                            setTimeout(function () {
                                    _this.loadATFAds2([dfpAds.slot]);
                            }, prebidTimeout2);  
                        }                      
                    });
                };
                AdManager.prototype.loadATFAds2 = function (prebidAdsSlot) {
                    var temp = prebidAdsSlot[0].getSlotElementId();
                    if (window.pbjs[temp])
                        return;
                    window.pbjs[temp] = true;
                    window.googletag.cmd.push(function () {
                        window.pbjs.que.push(function () {
                            window.googletag.pubads().refresh(prebidAdsSlot);
                        });
                    });
                };                
                AdManager.prototype.initPrebid = function (dfpAds) {
                    var _this = this;
                    var prebidTimeout = this.options.PREBID_TIMEOUT;
